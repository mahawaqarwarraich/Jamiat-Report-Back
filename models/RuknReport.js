...
const ruknDaySchema = require('./RuknDay');

const ruknReportSchema = new mongoose.Schema({
  user: {
...
ruknReportSchema.index({ user: 1, month: 1, year: 1 }, { unique: true });

module.exports = mongoose.model('RuknReport', ruknReportSchema);